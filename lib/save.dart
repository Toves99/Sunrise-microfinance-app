...
class _SaveState extends State<Save> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Save',style: TextStyle(fontSize: 16,color:Colors.white),),
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Text('Follow the below steps to save!',style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold,color:Colors.orange),),
