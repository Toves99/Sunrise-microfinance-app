...
class _PayLoanState extends State<PayLoan> {
  ...
  void sentMessage() async {
    ...
    if (accountNumber != null) {
      ...
      String payLoanFlag='Pay Loan message';
      if (enteredMessage.isNotEmpty) {
        try {
          ...
          if (querySnapshot.docs.isNotEmpty) {
            ...
            await querySnapshot.docs.first.reference.update({'PayLoanMessage': enteredMessage});
            await querySnapshot.docs.first.reference.update({'payLoanFlag': payLoanFlag});
          ...
          showSnackBar('Error sending message: $e');
        }
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pay Loan',style: TextStyle(fontSize: 18,color:Colors.white,fontWeight: FontWeight.bold),),
        centerTitle: false,
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Text('Follow the below steps to pay loan!',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color:Colors.orange),),
