...
class _PayLoanState extends State<PayLoan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pay Loan',style: TextStyle(fontSize: 16,color:Colors.white),),
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Text('Follow the below steps to pay loan!',style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold,color:Colors.orange),),
