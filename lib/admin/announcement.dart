...
import 'package:microfinance/admin/postgeneralannouncement.dart';
...
import 'announcementtoauser.dart';
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('Manage Announcements', style: Theme.of(context).textTheme.headline6?.copyWith(
                      color: Colors.white
                  )),
                  subtitle: Padding(
          ...
          Container(
            ...
            child: Container(
              ...
              child: GridView.count(
                ...
                mainAxisSpacing: 30,
                children: [
                  itemDashboard('General',CupertinoIcons.bell, Colors.deepOrange, () {
                    // Navigate to another page when My Savings is clicked
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const Generalannouncement()));
                  }),
                  itemDashboard('To a user', CupertinoIcons.bell, Colors.purple,(){
